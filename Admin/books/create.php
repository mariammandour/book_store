...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (count($errors) > 0) {
        ...
        $sql = "INSERT INTO `books`(`name`, `description`, `image`, `price`, `author_id`, `category_id`) VALUES  ('$name','$description','$disPath',$price,$author_id,$cat_id)";
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">Dashboard/book/create</li>
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputName" name="price" aria-describedby="" placeholder="Enter Title">
                        </div>
                        ...
                        <select class="form-control" id="exampleInputPassword1" name="author_id">
                            ...
                            <?php
                                while($data = mysqli_fetch_assoc($author)){
                            ?>
